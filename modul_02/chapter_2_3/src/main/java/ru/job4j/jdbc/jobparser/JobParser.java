...
public class JobParser {
    ...
    private void init() {
        ...
        try {
            InputStream inputStream = JobParser.class.
                    getClassLoader().getResourceAsStream("jobparser.properties");
    ...
    private JobOffer parsOffer(Element trElement) {
        ...
        offer.setUpdated(newUpdateDate);
        return offer;
    }
    ...
    private void startProgram() {
        ...
        updateDate = sqlHandler.getUpdateDate();
        if (updateDate == null) {
    ...
    private void startParser() {
        ...
        if (baseHasActualDate) {
            ...
            LOGGER.debug("Дата последнего обновления установлена на: " + updateDate);
            newUpdateDate = updateDate.plusMinutes(updateTimeout);
